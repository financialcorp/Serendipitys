...
const TEXT_COLOR = "#1f1a18";
const NAVY = TEXT_COLOR;
...
function CardIcons() {
  return (
    <div style={{ display: "flex", gap: 6, alignItems: "center", marginTop: 14 }}>
      <div style={{ width: 52, height: 33, border: "1px solid #ddd", borderRadius: 4, background: "#f4e8ef", display: "flex", alignItems: "center", justifyContent: "center", overflow: "hidden" }}>
...
function SuccessScreen({
  ...
  return (
    ...
    >
      ...
      {/* Next steps */}
      <div style={{ background: "#f7eef1", borderRadius: 6, padding: "14px 18px", marginBottom: 28, fontSize: 13, color: "#555", lineHeight: 1.7 }}>
    ...
    <div style={base}>
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "20px 28px 48px" }}>
        ...
        {(booking.name || booking.eventType) && (
          <div style={{ background: "#f7eef1", border: "1px solid #e9d8dc", borderRadius: 6, padding: "10px 16px", marginBottom: 24, fontSize: 13, color: "#444", display: "flex", gap: 20, flexWrap: "wrap" }}>
          ...
          <div style={{ marginLeft: 180, marginBottom: 6 }}>
            <div style={{ display: "flex", alignItems: "center", marginBottom: 6 }}>
              ...
              <input
                ...
                readOnly
                style={{ ...inputBase, width: 110, background: "#f9f0f2", color: payMethod === "cc" && surchargeNum > 0 ? "#c0392b" : "#999", fontSize: 14, fontWeight: payMethod === "cc" && surchargeNum > 0 ? 600 : 400 }}
              />
            </div>
            <div style={{ display: "flex", alignItems: "center", marginBottom: 6 }}>
              ...
              <input
                ...
                value={`$${grandStr}`}
                readOnly
                style={{ ...inputBase, width: 110, background: "#f9f0f2", color: GREEN, fontSize: 15, fontWeight: 700 }}
              />
            </div>
